...
public class GeradorCadastroFormMuiraquita extends CalangoFactory {
	...
	for (Entity entidade : projeto.getEntidades()) {
	    ...
	    String nomePagina = StringUtil.toTableSintaxFormt(entidade.getNomeEntidade()) + "_form.xhtml";
	    ...
	    srtBuffer.append("<ui:define name=\"titulo\">" + StringUtil.toLabelSintaxFormt(entidade.getNomeEntidade()) + "</ui:define> \n\t");
	    srtBuffer.append("<ui:define name=\"caminho\">" + StringUtil.toLabelSintaxFormt(entidade.getNomeEntidade()) + " - Cadastro</ui:define> \n\t");
	    srtBuffer.append("\n\t\t");
