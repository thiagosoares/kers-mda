...
@Deprecated
public class GeradorEntityMuiraquitaLigth {

    public GeradorEntityMuiraquitaLigth() {
    }
	...
	for (Entity entidade : projeto.getEntidades()) {
	    ...
	    srtBuffer.append(entidade.getPackageClasse() + "; \n\n");
	    ...
	    srtBuffer.append("@Table(name = \""+ StringUtil.toTableSintaxFormt(entidade.getNomeEntidade()).toUpperCase() +"\", schema = \"" + projeto.getSchemaAplicacao() + "\") \n");
