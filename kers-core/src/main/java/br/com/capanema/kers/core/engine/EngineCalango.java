...
import br.com.capanema.kers.core.factory.pages.form.GeradorCadastroFormCalango;
import br.com.capanema.kers.core.factory.pages.list.GeradorBuscasCalango;
import br.com.capanema.kers.core.factory.pages.list.ListPAgeBuilder;
import br.com.capanema.kers.core.factory.pages.update.GeradorAlteracaoFormCalango;
...
public class EngineCalango extends AbstractEngine {

  public EngineCalango(TemplateConfig parametros) throws ConfigurationException, IOException {
    super(parametros);
  }
