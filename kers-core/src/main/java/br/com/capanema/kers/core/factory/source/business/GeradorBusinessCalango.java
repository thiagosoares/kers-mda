...
public class GeradorBusinessCalango extends CalangoFactory {
	...
	for (Entity entidade : projeto.getEntidades()) {
	    ...
	    srtBuffer.append("private " + entidade.getNomeEntidade() + " " + entidade.getNomeVarEntidade() + "Update; \n");
	    srtBuffer.append("\n ");
	    ...
	    srtBuffer.append("public " + nomeClasse + "(" + entidade.getNomeEntidade() + " " + entidade.getNomeVarEntidade()
		    + ", Usuario usuario) { \n \t");
	    srtBuffer.append("super.usuarioSession = usuario; \n\t");
	    ...
	    srtBuffer.append("public " + nomeClasse + "(" + entidade.getNomeEntidade() + " " + entidade.getNomeVarEntidade() + ", "
		    + entidade.getNomeEntidade() + " " + entidade.getNomeVarEntidade() + "Update, Usuario usuario) { \n \t");
	    srtBuffer.append("super.usuarioSession = usuario; \n\t");
	    srtBuffer.append("super.manipulador = this.manipulador; \n\n\t");

	    srtBuffer.append("this." + entidade.getNomeVarEntidade() + " = " + entidade.getNomeVarEntidade() + "; \n\t");
	    srtBuffer.append("this." + entidade.getNomeVarEntidade() + "Update = " + entidade.getNomeVarEntidade() + "Update; \n");
	    srtBuffer.append("} \n");
	    srtBuffer.append("\n \n");
	    ...
	    srtBuffer.append("public void validarInclusao() throws NegocioException { \n \t");
	   ...
	   // srtBuffer.append("setarSituacaoCadastro(); \n \t");
	    ...
	    srtBuffer.append("public void validarAlteracao() throws NegocioException { \n \t");
	    ...
	    srtBuffer.append("public void validarExclusao() throws NegocioException { \n \t");
	    ...
	    srtBuffer.append("/** \n");
	    srtBuffer.append("* Metodos de auxilio � manipula��o do registro \n");
	    srtBuffer.append("*/ \n \n");
	    ...
	    srtBuffer.append("this." + entidade.getNomeVarEntidade() + ".setSITUACAO(Situacao.ATIVO); \n \t");
	    srtBuffer.append("this." + entidade.getNomeVarEntidade() + ".setDATASITUACAO(new Date()); \n");
	    srtBuffer.append("} ");
	    srtBuffer.append("\n \n");*/
	   ...
	   /* srtBuffer.append("// Metodo para setar a situa��o do registro na altera��o \n");
	    ...
	    srtBuffer.append("if(this." + entidade.getNomeVarEntidade() + ".getSITUACAO() != this." + entidade.getNomeVarEntidade()
		    + ".getSITUACAO()); \n \t\t");
	    srtBuffer.append("this." + entidade.getNomeVarEntidade() + ".setDATASITUACAO(new Date()); \n \t");
	    srtBuffer.append("} \n");
	    srtBuffer.append("} ");
		...
		if (atributo.getTipo().equals("String")) {
		    srtBuffer.append("\n\t");
		    srtBuffer.append("if(StringUtils.isEmpty(this." + entidade.getNomeVarEntidade() + "." + atributo.getGetMetodo() + "())) { \n \t\t");
		    ...
		    srtBuffer.append("\n\t");
		    srtBuffer.append("if(this." + entidade.getNomeVarEntidade() + "." + atributo.getGetMetodo() + "() == null) { \n \t\t");
		    srtBuffer.append("manipulador.ERRO_VALIDACAO(" + atributo.getNome().toUpperCase() + "_NULL); \n \t");
		    srtBuffer.append("}");
		}
	    }
