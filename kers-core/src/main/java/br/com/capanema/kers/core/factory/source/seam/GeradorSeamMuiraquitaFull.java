...
public class GeradorSeamMuiraquitaFull extends CalangoFactory {

  public GeradorSeamMuiraquitaFull() {
  }
  ...
  public static void build(EAProjectConfig projeto) throws IOException {
    ...
    for (Entity entidade : projeto.getEntidades()) {
      ...
      if (!entidade.getIsEnum()) {
        ...
        srtBuffer.append("*/ \n");
        srtBuffer.append("private static final String START_PAGE = \"/" + StringUtil.toTableSintaxFormt(projeto.getNomeSistema()) + "/"
                + StringUtil.toTableSintaxFormt(entidade.getNomeEntidade()) + "/" + StringUtil.toTableSintaxFormt(entidade.getNomeEntidade())
                + "_list.xhtml\"; \n");
        srtBuffer.append("private static final String FORM_PAGE = \"/" + StringUtil.toTableSintaxFormt(projeto.getNomeSistema()) + "/"
                + StringUtil.toTableSintaxFormt(entidade.getNomeEntidade()) + "/" + StringUtil.toTableSintaxFormt(entidade.getNomeEntidade())
                + "_form.xhtml\"; \n");
